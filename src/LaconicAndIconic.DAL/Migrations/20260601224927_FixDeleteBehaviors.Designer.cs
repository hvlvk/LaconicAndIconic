...
namespace LaconicAndIconic.DAL.Migrations
{
    ...
    [Migration("20260601224927_FixDeleteBehaviors")]
            ...
            modelBuilder.Entity("LaconicAndIconic.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3389),
                            Name = "Сніданки"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3391),
                            Name = "Перші страви"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3392),
                            Name = "Основні страви"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3394),
                            Name = "Салати"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3395),
                            Name = "Десерти"
                        },
                        new
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3397),
                            Name = "Закуски"
                        },
                        new
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3398),
                            Name = "Випічка"
                        },
                        new
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3399),
                            Name = "Вегетаріанські страви"
                        },
                        new
                        {
                            Id = 9,
                            CreatedAt = new DateTime(2026, 6, 1, 22, 49, 27, 117, DateTimeKind.Utc).AddTicks(3401),
                            Name = "Напої"
                        });
                });
