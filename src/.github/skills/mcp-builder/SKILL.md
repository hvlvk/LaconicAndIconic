...
**Recommended stack:**
- **Language**: TypeScript (high-quality SDK support and good compatibility in many execution environments) or Python (FastMCP high-level framework)
...
Follow the evaluation guide to:
